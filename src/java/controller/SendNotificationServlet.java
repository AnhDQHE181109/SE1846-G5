...
public class SendNotificationServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet SendNotificationServlet</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet SendNotificationServlet at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
    ...
    throws ServletException, IOException {
        int suID = Integer.parseInt(request.getParameter("su"));
        String message = request.getParameter("message");
        NotificationAlertDAO notiDAO = new NotificationAlertDAO();
        notiDAO.send(suID, message);
